...
public class CandidateEntity {
    ...
    @Schema(example = "João Paulo", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
    private String name;

    @NotBlank
    @Pattern(regexp = "\\S+", message = "O campo [username] não deve conter espaços!")
    @Schema(example = "joaopaulo", requiredMode = RequiredMode.REQUIRED, description = "Username do candidato")
